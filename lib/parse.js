...
// TODO: Improve handling of passing string schema (allowed only for names).
...
/**
 * Initialize registry, adding all primitives.
 *
 */
...
function AvroUnion(schema, namespace, registry) {
  ...
  this.types = schema.map(function (o) { return parse(o, namespace, registry); });
...
function AvroFixed(schema, namespace, registry) {
  ...
  this.name = resolveName(schema, namespace);
