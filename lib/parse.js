...
function parse(schema, namespace, registry) {
  ...
  registry = registry || Type.createRegistry();
  ...
  if (schema instanceof Array) { // Union.
    return new UnionType(schema, namespace, registry);
  }
  ...
  switch (type) { // Non-union complex types.
    ...
    case 'array':
      return new ArrayType(schema, namespace, registry);
    case 'enum':
      return new EnumType(schema, namespace, registry);
    case 'fixed':
      return new FixedType(schema, namespace);
    case 'map':
      return new MapType(schema, namespace, registry);
    case 'record':
      return new RecordType(schema, namespace, registry);
    default:
...
function UnionType(schema, namespace, registry) {
...
function EnumType(schema, namespace, registry) {
...
function FixedType(schema, namespace, registry) {
...
function MapType(schema, namespace, registry) {
...
function ArrayType(schema, namespace, registry) {
...
function RecordType(schema, namespace, registry) {
