  ...
  switch (name) {
    ...
    case 'boolean':
      ...
      this.random = function () {
        return !!(Math.random() < 0.5); // jshint ignore: line
      };
      break;
    case 'int':
    ...
    case 'bytes':
      ...
      this.random = function () {
        this.random = new Buffer(randomString(randomDouble(1, 32)));
      };
      break;
    default:
...
RecordType.prototype.random = function () {
  ...
  return new (this._create.bind.apply(this._create, fields)); // jshint ignore: line
