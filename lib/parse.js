...
/**
 * Read an Avro type from a tap.
 *
 */
AvroType.prototype.read = function (tap) { return this._reader.call(tap); };

/**
 * Write an Avro type to a tap.
 *
 */
AvroType.prototype.write = function (obj, tap) { this._writer.call(tap, obj); };
