...
AvroType.prototype._check = function (obj) {
  ...
  // TODO: Make this return something else than a boolean so that union can use
  // its return value directly. (E.g. -1).
 ...
 *
 *  + `size`, used to initialize the buffer. Defaults to 64 bytes.
...
function AvroUnion(types) {
  ...
  var writers = types.map(function (obj) { return obj._write; });

  this.types = types;
  this._read = function () { return reader.call(this, readers); };
  this._write = function (obj) { return writer.call(this, obj, writers); };
...
function AvroRecord(name, doc) {
  ...
  this._check = function (obj) { // TODO: Code generate this.
    ...
    return this.fields.every(function (field) {
      return field.type._check(obj[field.name] || field['default']);
    });
  };
