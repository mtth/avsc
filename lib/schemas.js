 ...
 * constructor call) and for messages (which are defined without a name, so as
 * not to collide with records and errors).
 *
 */
function RecordType(attrs, opts) {
  ...
  this._name = resolutions.name;
  this._aliases = resolutions.aliases;
  Type.call(this, attrs.type === 'message' ? undefined : opts.registry);
