...
Tap.prototype.readInt = Tap.prototype.readLong = function () {
  ...
  // If reading past the end of the buffer, this methods will return 0.
...
Tap.prototype.writeFloat = function (f) {
  ...
  return this.buf.writeFloatLE(f, offset);
...
Tap.prototype.writeDouble = function (d) {
  ...
  return this.buf.writeFloatLE(d, offset);
...
Tap.prototype.writeFixed = function (buf, len) {
  ...
  buf.copy(this.buf, offset, 0, len);
