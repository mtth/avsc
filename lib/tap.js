...
Tap.prototype.readArray = function (fn, ctx) {
  var arr = [];
  var n;
  while ((n = this.readLong())) {
    ...
    while (n--) {
      arr.push(fn.call(ctx, this));
    }
  }
  return arr;
};

Tap.prototype.skipArray = function (fn, ctx) {
  var len, n;
  while ((n = this.readLong())) {
    if (n < 0) {
      len = this.readLong();
...
Tap.prototype.writeArray = function (arr, fn, ctx) {
  var n = arr.length;
  var i;
  if (n) {
    this.writeLong(n);
    for (i = 0; i < n; i++) {
      fn.call(ctx, this, arr[i]);
    }
  }
  this.writeLong(0);
};

Tap.prototype.readMap = function (fn, ctx) {
  var obj = {};
  var n;
  while ((n = this.readLong())) {
    if (n < 0) {
    ...
    while (n--) {
      ...
      obj[key] = fn.call(ctx, this);
    }
  }
  return obj;
};

Tap.prototype.skipMap = function (fn, ctx) {
  var len, n;
  while ((n = this.readLong())) {
    if (n < 0) {
      len = this.readLong();
...
Tap.prototype.writeMap = function (obj, fn, ctx) {
