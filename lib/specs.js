 ...
 * + If `str` is a valid IDL protocol specification, it is parsed and returned if no
 *   imports are present (and an error is thrown if there are any imports).
