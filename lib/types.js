...
// TODO: Rename `wrapUnions` `clone` option to `wrapBranches`.
...
Type.prototype.getName = function (noUndef) {
  if (this._name || !noUndef) {
    return this._name;
  }
  ...
  // Return undefined for unions and requests (neither can be union branches).
};
