...
function PrimitiveType(type) {
  Type.call(this, type); // TODO: Rename to _type
}
...
NullType.prototype._read = function (t) { return t.readNull(); };
NullType.prototype._skip = function (t) { t.skipNull(); };
NullType.prototype._write = function (t, o) { t.writeNull(o); };
...
BooleanType.prototype._read = function (t) { return t.readBoolean(); };
BooleanType.prototype._skip = function (t) { t.skipBoolean(); };
BooleanType.prototype._write = function (t, o) { t.writeBoolean(o); };
...
IntType.prototype._read = function (t) { return t.readInt(); };
IntType.prototype._skip = function (t) { t.skipInt(); };
IntType.prototype._write = function (t, o) { t.writeInt(o); };
IntType.prototype.isValid = function (o) { return o === (o | 0); };
IntType.prototype.random = function () { return RANDOM.nextInt(1000) | 0; };

function LongType() { PrimitiveType.call(this, 'long'); }
util.inherits(LongType, PrimitiveType);
LongType.prototype._read = function (t) { return t.readLong(); };
LongType.prototype._skip = function (t) { t.skipLong(); };
LongType.prototype._write = function (t, o) { t.writeLong(o); };
...
FloatType.prototype._read = function (t) { return t.readFloat(); };
FloatType.prototype._skip = function (t) { t.skipFloat(); };
FloatType.prototype._write = function (t, o) { t.writeFloat(o); };
...
DoubleType.prototype._read = function (t) { return t.readDouble(); };
DoubleType.prototype._skip = function (t) { t.skipDouble(); };
DoubleType.prototype._write = function (t, o) { t.writeDouble(o); };
...
StringType.prototype._read = function (t) { return t.readString(); };
StringType.prototype._skip = function (t) { t.skipString(); };
StringType.prototype._write = function (t, o) { t.writeString(o); };
...
BytesType.prototype._read = function (t) { return t.readBytes(); };
BytesType.prototype._skip = function (t) { t.skipBytes(); };
BytesType.prototype._write = function (t, o) { t.writeBytes(o); };
...
FixedType.prototype._read = function (tap) { return tap.readFixed(this.size); };
FixedType.prototype._skip = function (tap) { tap.skipFixed(this.size); };
FixedType.prototype._write = function (tap, buf) { tap.writeFixed(buf, this.size); };
...
MapType.prototype._write = function (tap, obj) {
  ...
  if (n) {
    ...
    for (i = 0; i < n; i++) {
      key = keys[i];
      tap.writeString(key);
      this.values._write(tap, obj[key]);
    }
  }
  tap.writeLong(0);
};
...
MapType.prototype._createResolver = function (type, opts) {
  if (type instanceof MapType) {
    ...
    return function (tap) {
      return tap.readMap(function () { return resolver._read(this); });
    };
  }
};
...
ArrayType.prototype._createResolver = function (type, opts) {
  if (type instanceof ArrayType) {
    ...
    return function (tap) {
      return tap.readArray(function () { return resolver._read(this); });
    };
  }
};
