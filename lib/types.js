...
// TODO: Add `isValid` `noUndeclaredFields` option which fails if a record's
// type is missing fields present in the value.
...
Type.prototype.isValid = function (val, opts) {
  var flags = {noUndeclaredFields: opts && opts.noUndeclaredFields};
