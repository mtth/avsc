...
// TODO: Add `compare` method (bytes and objects?).
...
Type.prototype.compareBuffers = function (buf1, buf2) {
  return this._compare(new Tap(buf1), new Tap(buf2));
};
...
Type.prototype.compareObjects = utils.abstractFunction;
...
NullType.prototype._compare = function () { return 0; };
...
BooleanType.prototype._compare = function (tap1, tap2) {
...
IntType.prototype._compare = function (tap1, tap2) {
...
LongType.prototype._compare = function (tap1, tap2) {
...
FloatType.prototype._compare = function (tap1, tap2) {
...
DoubleType.prototype._compare = function (tap1, tap2) {
...
StringType.prototype._compare = function (tap1, tap2) {
...
BytesType.prototype._compare = function (tap1, tap2) {
...
UnionType.prototype._compare = function (tap1, tap2) {
  var n1 = tap1.readLong();
  var n2 = tap2.readLong();
  if (n1 === n2) {
    return this._types[n1]._compare(tap1, tap2);
  } else {
    return n1 < n2 ? -1 : 1;
  }
};
...
EnumType.prototype._compare = function (tap1, tap2) {
  return tap1.compareLong(tap2);
};
...
FixedType.prototype._compare = function (tap1, tap2) {
...
MapType.prototype._compare = function () {
...
ArrayType.prototype._compare = function (tap1, tap2) {
  var compare = this._items._compare;
  var n1 = tap1.readLong();
  var n2 = tap2.readLong();
  var f;
  while (n1 && n2) {
...
RecordType.prototype._compare = function (tap1, tap2) {
...
function Field(schema, opts) {
  ...
  this._order = (function (order) {
    switch (order) {
      ...
      default: throw new Error(f('invalid order: %j', order));
    }
  })(schema.order || 'ascending');
