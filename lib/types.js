...
/** Type factory method. */
Type.create = function (attrs, opts) {
  if (attrs === null) {
  ...
  if (typeof attrs == 'string') { // Type reference.
    ...
    if (isPrimitive(attrs)) {
      ...
      // reference.
      return opts.registry[attrs] = Type.create({type: attrs}, opts);
    }
...
function UnionType(attrs, opts) {
  ...
  this._types = attrs.map(function (obj) { return Type.create(obj, opts); });
...
function MapType(attrs, opts) {
  ...
  this._values = Type.create(attrs.values, opts);
}
...
function ArrayType(attrs, opts) {
  ...
  this._items = Type.create(attrs.items, opts);
}
...
function LogicalType(attrs, opts) {
  ...
  Type.call(this);
  LOGICAL_TYPE = this;
  this._underlyingType = Type.create(attrs, opts);
}
...
function Field(attrs, opts) {
  ...
  this._name = name;
  this._type = Type.create(attrs.type, opts);
  this._aliases = attrs.aliases || [];
