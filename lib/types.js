...
Type.prototype.createResolver = function (type, opts) {
  ...
  var resolver, key;
  if (
    this.getTypeName() === 'record' && type.getTypeName() === 'record' ||
    this.getTypeName() === 'error' && type.getTypeName() === 'error'
  ) {
...
Type.prototype.inspect = function () {
  var className = getClassName(this.getTypeName());
  if (isPrimitive(this.getTypeName())) {
...
EnumType.prototype.toJSON = function () {
  return {name: this._name, type: this.getTypeName(), symbols: this._symbols};
};
...
FixedType.prototype.toJSON = function () {
  return {name: this._name, type: this.getTypeName(), size: this._size};
};
