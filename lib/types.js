...
LongType.prototype.isValid = function (o) {
  // Can't capture full range sadly, so we play safe and throw rather than
  // potentially change the data. We don't use the `Number` constants because
  // they aren't available in some older browsers.
  return typeof o == 'number' &&
    o % 1 === 0 &&
    o <= 9007199254740991 && // Number.MAX_SAFE_INTEGER
    o >= -9007199254740991; // Number.MIN_SAFE_INTEGER
};
