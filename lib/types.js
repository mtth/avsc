...
function EnumType(schema, opts) {
  ...
  if (schema.default !== undefined && this._indices[schema.default] === undefined) {
    throw new Error(f('invalid default symbol: %j', schema.default));
  }

  this.defaultSymbol = schema.default;
  Object.freeze(this);
}
...
EnumType.prototype._update = function (resolver, type) {
  ...
  var symbols = type.symbols.slice();
  var i, l, symbol;
