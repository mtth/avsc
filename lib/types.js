...
WrappedUnionType.prototype._copy = function (val, opts) {
  ...
  if (wrap === 2) {
    ...
    return new this._constructors[0](this.types[0]._copy(val, opts));
  }
...
function RecordType(schema, opts) {
  ...
  this.valueConstructor = this._createConstructor();
...
RecordType.prototype._createReader = function () {
  // jshint -W054
  var names = [];
  var values = [this.valueConstructor];
  var i, l;
  for (i = 0, l = this.fields.length; i < l; i++) {
    names.push('t' + i);
...
RecordType.prototype._copy = function (val, opts) {
  ...
  var Record = this.valueConstructor;
