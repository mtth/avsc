...
// type hook).
// TODO: Add `toJson` and `fromJSON` methods for records (handling buffers
// correctly).
...
/**
 * Resize underlying encoding buffer.
 *
 * @param size {Number} New buffer size.
 *
 * In general, you should only ever need to call this if you are encoding large
 * objects and need to reclaim memory.
 *
 */
 ...
 *
 */
Type.prototype.encode = function (obj, unsafe) {
