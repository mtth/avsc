...
// TODO: Cache hash string on each type, this would allow easy comparison.
...
Type.prototype.encode = function (val, buf, pos) {
  ...
  if (!tap.isValid()) {
    ...
    // minimum size required to ease resizing.
    return -tap.pos;
  }
  return tap.pos;
};
...
Type.prototype.equals = function (type) {
  return this.getFingerprint().equals(type.getFingerprint());
};
