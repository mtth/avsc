...
PrimitiveType.prototype._check = function (obj, cb) {
...
RecordType.prototype._createChecker = function () {
  ...
  body += '    if (cb) { cb(obj, this, PATH.slice()); }\n';
  body += '    return false;\n';
  body += '  }\n';
  for (i = 0, l = this._fields.length; i < l; i++) {
    field = this._fields[i];
  ...
  body += '  var b = true;\n';
  body += '  if (cb) {\n';
  body += '    var j = PATH.length;\n';
  body += '    PATH.push(\'\');\n';
  var i, l, field;
  for (i = 0, l = this._fields.length; i < l; i++) {
    field = this._fields[i];
    body += '    PATH[j] = \'' + field._name + '\';\n';
    if (field.getDefault() === undefined) {
      body += '    if (!t' + i + '._check(obj.' + field._name + ', cb)) { ';
    } else {
