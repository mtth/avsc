...
// TODO: Change type hook (moving it before the type is registered, supporting
// switching out types for others).
 ...
 *
 */
function SlowLongType(opts) {
  LongType.call(this);
  this._unpack = opts && opts.unpack !== undefined ? !!opts.unpack : true;

  // Allow defining an instance via options (similar to the streams API).
  var names = ['read', 'write', 'fromJSON', 'compare', 'isValid', 'random'];
...
util.inherits(SlowLongType, LongType);
SlowLongType.prototype._read = function (tap) {
  var buf, pos;
  if (this._unpack) {
...
SlowLongType.prototype._write = function (tap, o) {
  var buf = this.write(o);
  if (this._unpack) {
...
SlowLongType.prototype.clone = function (o) {
  ...
  return this.fromJSON(JSON.parse(JSON.stringify(o)));
};
SlowLongType.prototype.random = function () {
  return this.clone(LongType.prototype.random());
};

// Methods to be implemented by the user.
SlowLongType.prototype.read = utils.abstractFunction;
SlowLongType.prototype.write = utils.abstractFunction;
SlowLongType.prototype.fromJSON = utils.abstractFunction;
SlowLongType.prototype.compare = utils.abstractFunction;
SlowLongType.prototype.isValid = utils.abstractFunction;
...
module.exports = (function () {
  ...
  var obj = {Type: Type, SlowLongType: SlowLongType};
