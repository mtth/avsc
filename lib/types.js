...
function PrimitiveType(name) {
  ...
  switch (name) {
    case 'null':
      this._read = function (t) { return t.readNull(); };
      this._skip = function (t) { t.skipNull(); };
      this._write = function (t, o) { t.writeNull(o); };
      this.isValid = function (o) { return o === null; };
      this.random = function () { return null; };
      break;
    case 'boolean':
      this._read = function (t) { return t.readBoolean(); };
      this._skip = function (t) { t.skipBoolean(); };
      this._write = function (t, o) { t.writeBoolean(o); };
      this.isValid = function (o) { /* jshint -W018 */ return o === !!o; };
      this.random = function () { return RANDOM.nextBoolean(); };
      break;
    case 'int':
      this._read = function (t) { return t.readInt(); };
      this._skip = function (t) { t.skipInt(); };
      this._write = function (t, o) { t.writeInt(o); };
      this.isValid = function (o) { return o === (o | 0); };
      this.random = function () { return RANDOM.nextInt(1000) | 0; };
      break;
    case 'long':
      this._read = function (t) { return t.readLong(); };
      this._skip = function (t) { t.skipLong(); };
      this._write = function (t, o) { t.writeLong(o); };
      ...
      break;
    case 'float':
      this._read = function (t) { return t.readFloat(); };
      this._skip = function (t) { t.skipFloat(); };
      this._write = function (t, o) { t.writeFloat(o); };
      this.isValid = function (o) {
      ...
      break;
    case 'double':
      this._read = function (t) { return t.readDouble(); };
      this._skip = function (t) { t.skipDouble(); };
      this._write = function (t, o) { t.writeDouble(o); };
      this.isValid = function (o) { return typeof o == 'number'; };
      this.random = function () { return RANDOM.nextFloat(); };
      break;
    case 'string':
      this._read = function (t) { return t.readString(); };
      this._skip = function (t) { t.skipString(); };
      this._write = function (t, o) { t.writeString(o); };
      ...
      break;
    case 'bytes':
      this._read = function (t) { return t.readBytes(); };
      this._skip = function (t) { t.skipBytes(); };
      this._write = function (t, o) { t.writeBytes(o); };
