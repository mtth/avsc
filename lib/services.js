...
Service.prototype.emit = util.deprecate(
  function (name, req, stub, cb) {
    if (!stub || !this.equals(stub.getProtocol())) {
...
Client.prototype.getStubs = function () {
  return Object.freeze(this._stubs$.slice());
};
...
Server.prototype.getStubs = function () {
  return Object.freeze(utils.objectValues(this._stubs));
};
...
StatefulClientStub.prototype._send = function (id, reqBuf, isOneWay) {
  if (!this._connected) {
