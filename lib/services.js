...
Client.prototype.emitMessage = function (name, req, opts, cb) {
  ...
  var wreq = new WrappedRequest(msg, {}, req, opts && opts.context);
...
Client.prototype._createMessageHandler = function (msg) {
  ...
  body += '\n  };\n';
  body += '  var wreq = new WrappedRequest(';
  body += 'msg, {}, req, opts && opts.context);\n';
...
function WrappedRequest(msg, hdr, req, ctx) {
  this._msg = msg;
  this._hdr = hdr || {};
  this._req = req || {};
  this._ctx = ctx;
...
WrappedRequest.prototype.getContext = function () { return this._ctx; };
...
Adapter.prototype._decodeRequest = function (buf) {
  ...
  return new WrappedRequest(msg, hdr, req); // No context here.
};
