...
MessageEmitter.prototype._emit = function (wreq, opts, cb) {
  ...
  var ctx = expandOption(this._client._callContext$, [this, opts]);
  var self = this;
  this._pending++;
  process.nextTick(function () {
...
function MessageListener(server, opts) {
  ...
  this._prefix = normalizedPrefix(opts.scope);
  this._errorFormatter = opts.errorFormatter;
  this._contextOpts = opts.contextOptions;
...
MessageListener.prototype._receive = function (reqBuf, adapter, cb) {
  ...
  var ctx = expandOption(this._server._callContext, [this, this._contextOpts]);
  self._pending++;
  chainFunctions(
    this._server._fns,
    ctx,
