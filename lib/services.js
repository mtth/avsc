...
ClientStub.prototype._emit = function (wreq, opts, cb) {
  ...
  var ctx = this.client._legacy$ ? this : new CallContext(msg, this);
  var self = this;
  this.pending++;
  process.nextTick(function () {
    if (!msg.name) {
...
ClientStub.prototype.getPending = util.deprecate(
  function () { return this.pending; },
  'user `pending` instead'
);
...
ServerStub.prototype._receive = function (reqBuf, adapter, cb) {
  ...
  var ctx = this.server._legacy ? this : new CallContext(msg, this);
...
ServerStub.prototype.getPending = util.deprecate(
  function () { return this.pending; },
  'user `pending` instead'
);
