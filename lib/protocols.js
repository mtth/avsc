...
StatelessEmitter.prototype._emit = function (message, req, cb) {
  if (this._destroyed) {
    callAsync(this._ptcl, cb, this._ptcl._toSystemError('emitter destroyed'));
    return;
  }
  ...
  var self = this;
  callAsync(undefined, emit, false);
...
StatefulEmitter.prototype._emit = function (message, req, cb) {
  if (this._destroyed) {
    callAsync(undefined, cb, this._ptcl._toSystemError('emitter destroyed'));
    return;
  }
  ...
  function emit() {
    ...
    try {
      ...
      self._popCall(id);
      callAsync(undefined, cb, self._ptcl._toSystemError(err));
      return;
    }
 ...
 *
 */
function callAsync(ctx, cb, err, res) {
  process.nextTick(function () { cb.call(ctx, err, res); });
}
