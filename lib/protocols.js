...
// Note the added default for convenience.
 ...
 * An Avro protocol.
 *
 * It contains a cache for all remote protocols encountered its clients and
 * servers.
 *
 */
...
Protocol.prototype._getHash = function () {
...
Protocol.prototype.createClient = function (transport, opts, cb) {
  ...
  if (typeof transport == 'function') {
    ...
    client = new StatefulClient(this, transport, transport, opts);
  } else {
...
Client.prototype._validateHandshake = function (tap, handshakeReq) {
  ...
  if (res.serverHash && res.serverProtocol) {
    ...
    var serverPtcl = createProtocol(res.serverProtocol.string, this._ptclHook);
...
Channel.prototype._validateHandshake = function (reqTap, resTap) {
  ...
  var handshakeRes = new HandshakeResponse(
    ...
    serverMatch ? null : {'org.apache.avro.ipc.MD5': this._ptcl._getHash()},
