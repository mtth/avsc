...
function parse(any, opts) {
  var schema = specs.parse(any);
  return schema.protocol ?
    services.Service.forProtocol(schema, opts) :
...
module.exports = {
  ...
  Type: types.Type,
  assembleSpec: specs.assembleSpec,
  ...
  parse: parse,
  parseServiceSpec: specs.parseServiceSpec,
  parseTypeSpec: specs.parseTypeSpec,
