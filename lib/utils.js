...
/**
 * `process.nextTick`, but backfilled for node <= 1.
 *
 * @param fn {Function} Callback.
 * @param arg {...} Anything.
 *
 * Only supports a single argument (the max currently needed in this package).
 *
 */
function nextTick(fn, arg) { process.nextTick(function () { fn(arg); }); }
