...
var Tap = utils.Tap;
var constructors = types.constructors;
var Type = constructors.Type;
var LogicalType = types.constructors.LogicalType;
...
suite('types', function () {
  ...
  suite('BooleanType', function () {
    ...
    testType(constructors.BooleanType, data);
  ...
  suite('LongType', function () {
    ...
    testType(constructors.LongType, data);
  ...
  suite('NullType', function () {
    ...
    testType(constructors.NullType, data);
  ...
  suite('FloatType', function () {
    ...
    testType(constructors.FloatType, data);
  ...
  suite('DoubleType', function () {
    ...
    testType(constructors.DoubleType, data);
  ...
  suite('BytesType', function () {
    ...
    testType(constructors.BytesType, data);
  ...
  suite('UnwrappedUnionType', function () {
    ...
    testType(constructors.UnwrappedUnionType, data, schemas);

    test('types', function () {
      var t = new constructors.UnwrappedUnionType(['null', 'int']);
      var ts = t.types;
    ...
    test('coerce buffers', function () {
      var type = new constructors.UnwrappedUnionType(['null', 'bytes']);
    ...
    test('resolve [string, int] to unwrapped [float, bytes]', function () {
      var t1 = new constructors.WrappedUnionType(['string', 'int']);
    ...
    test('clone', function () {
      var t = new constructors.UnwrappedUnionType(
    ...
    test('invalid null', function () {
      var t = new constructors.UnwrappedUnionType(['string', 'int']);
    ...
    test('compare', function () {
      var t;
      t = new constructors.UnwrappedUnionType(['null', 'int']);
  ...
  suite('WrappedUnionType', function () {
    ...
    testType(constructors.WrappedUnionType, data, schemas);
    ...
    test('resolve unwrapped [string, int] to [long, bytes]', function () {
      var t1 = new constructors.UnwrappedUnionType(['string', 'int']);
      var t2 = new constructors.WrappedUnionType(['long', 'bytes']);
      var a = t2.createResolver(t1);
      var buf;
      buf = t1.toBuffer('hi');
    ...
    test('clone', function () {
      var t = new constructors.WrappedUnionType(['null', 'int']);
      var o = {'int': 1};
      assert.strictEqual(t.clone(null), null);
      var c;
      c = t.clone(o);
    ...
    test('clone and wrap', function () {
      var t = new constructors.WrappedUnionType(['string', 'int']);
      var o;
    ...
    test('compare', function () {
      var t;
      t = new constructors.WrappedUnionType(['null', 'int']);
      assert.equal(t.compare(null, {'int': 3}), -1);
      assert.equal(t.compare(null, null), 0);
      t = new constructors.WrappedUnionType(['int', 'float']);
  ...
  suite('EnumType', function () {
    ...
    testType(constructors.EnumType, data, schemas);
    ...
    test('read invalid index', function () {
      var type = new constructors.EnumType({
    ...
    test('resolve', function () {
      ...
      function newEnum(name, symbols, aliases, namespace) {
        ...
        return new constructors.EnumType(obj);
      }
    });
  ...
  suite('FixedType', function () {
    ...
    test('resolve', function () {
      var t1 = new constructors.FixedType({name: 'Id', size: 4});
      var t2 = new constructors.FixedType({name: 'Id', size: 4});
      assert.doesNotThrow(function () { t2.createResolver(t1); });
      t2 = new constructors.FixedType({name: 'Id2', size: 4});
      assert.throws(function () { t2.createResolver(t1); });
      t2 = new constructors.FixedType({name: 'Id2', size: 4, aliases: ['Id']});
      assert.doesNotThrow(function () { t2.createResolver(t1); });
      t2 = new constructors.FixedType({name: 'Id2', size: 5, aliases: ['Id']});
      assert.throws(function () { t2.createResolver(t1); });
    });

    test('clone', function () {
      var t = new constructors.FixedType({name: 'Id', size: 2});
      var s = '\x01\x02';
      var buf = utils.bufferFrom(s);
      var clone;
      clone = t.clone(buf);
  ...
  suite('MapType', function () {
    ...
    testType(constructors.MapType, data, schemas);
    ...
    test('resolve int > long', function () {
      var t1 = new constructors.MapType({type: 'map', values: 'int'});
    ...
    test('resolve invalid', function () {
      var t1 = new constructors.MapType({type: 'map', values: 'int'});
      var t2 = new constructors.MapType({type: 'map', values: 'string'});
      assert.throws(function () { t2.createResolver(t1); });
      t2 = new constructors.ArrayType({type: 'array', items: 'string'});
      assert.throws(function () { t2.createResolver(t1); });
    });
  ...
  suite('ArrayType', function () {
    ...
    testType(constructors.ArrayType, data, schemas);
    ...
    test('resolve string items to bytes items', function () {
      var t1 = new constructors.ArrayType({type: 'array', items: 'string'});
    ...
    test('resolve invalid', function () {
      var t1 = new constructors.ArrayType({type: 'array', items: 'string'});
      var t2 = new constructors.ArrayType({type: 'array', items: 'long'});
      assert.throws(function () { t2.createResolver(t1); });
      t2 = new constructors.MapType({type: 'map', values: 'string'});
      assert.throws(function () { t2.createResolver(t1); });
    });
    ...
    test('isValid hook reentrant', function () {
      var t = new constructors.ArrayType({
        items: new constructors.ArrayType({items: 'int'})
      });
  ...
  suite('RecordType', function () {
    ...
    testType(constructors.RecordType, data, schemas);
    ...
    test('clone field hook', function () {
      ...
      var c = t.clone(o, {fieldHook: function (f, o, r) {
        ...
        return f.type instanceof constructors.StringType ? o.toUpperCase() : o;
      }});
  ...
  suite('AbstractLongType', function () {
    ...
    suite('unpacked', function () {
      ...
      var slowLongType = constructors.LongType.__with({
    ...
    test('within unwrapped union', function () {
      var longType = constructors.LongType.__with({
    ...
    test('incomplete buffer', function () {
      ...
      var slowLongType = new constructors.LongType.__with({
  ...
  suite('LogicalType', function () {
    ...
    AgeType.prototype._resolve = function (type) {
      if (Type.isType(type, 'logical:age')) {
        return this._fromValue;
      }
    };
    ...
    test('valid type', function () {
      ...
      assert(t.underlyingType instanceof constructors.LongType);
    ...
    test('invalid type', function () {
      ...
      assert(t instanceof constructors.IntType);
